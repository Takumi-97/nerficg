...
SPaGS::rasterization::forward_wrapper(
...
SPaGS::rasterization::backward_wrapper(
...
SPaGS::rasterization::inference_wrapper(
    const torch::Tensor& positions,
    const torch::Tensor& scales,
    const torch::Tensor& rotations,
    const torch::Tensor& opacities,
...
void
SPaGS::rasterization::update_max_weights_wrapper(
