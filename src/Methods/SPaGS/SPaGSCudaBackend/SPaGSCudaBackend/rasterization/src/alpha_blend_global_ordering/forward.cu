...
#include "alpha_blend_global_ordering/kernels/forward.cuh"
...
std::pair<int, int> SPaGS::rasterization::alpha_blend_global_ordering::forward(
    ...
    const float near)
{
    ...
    const int instance_primitive_indices_selector = per_instance_buffers.primitive_indices.selector;
