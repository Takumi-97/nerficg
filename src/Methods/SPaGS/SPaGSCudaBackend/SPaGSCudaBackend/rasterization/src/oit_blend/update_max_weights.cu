...
#include "oit_blend/kernels/update_max_weights.cuh"
...
void SPaGS::rasterization::oit_blend::update_max_weights(
    ...
    const float weight_threshold)
{
    ...
    constexpr bool store_rgb = false, store_rgb_clamp_info = false;
