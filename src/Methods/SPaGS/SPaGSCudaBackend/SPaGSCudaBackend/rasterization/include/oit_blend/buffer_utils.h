...
namespace SPaGS::rasterization::oit_blend {
    ...
    struct PerPrimitiveBuffers {
        ...
        static PerPrimitiveBuffers from_blob(char*& blob, size_t n_primitives, bool store_rgba, bool store_rgb_clamp_info) {
            ...
            obtain(blob, buffers.MT1, n_primitives, 128);
            obtain(blob, buffers.MT2, n_primitives, 128);
    ...
    struct PerPixelBuffers {
        float* grad_info; // rgb, alpha_sum_rcp, transmitance
